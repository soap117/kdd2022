...
class BertSelfAttention(nn.Module):
    ...
    def forward(
        ...
        if attention_adjust is not None and self.layer_idx < 3:
            ...
            attention_scores = (1 / float(self.layer_idx + 1)) * attention_adjust_ * attention_scores + (
                        1 - 1 / float(self.layer_idx + 1)) * attention_scores
...
class BertLayer(nn.Module):
    def __init__(self, config, layer_idx=None):
        ...
        self.seq_len_dim = 1
        self.attention = BertAttention(config, layer_idx)
        self.is_decoder = config.is_decoder
