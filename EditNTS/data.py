...
class Vocab():
    def __init__(self):
        self.word_list = [PAD, UNK, KEEP, DEL, START, STOP, INSERT]
        self.w2i = {}
        self.i2w = {}
        self.count = 0
        self.embedding = None
    ...
    def add_embedding(self, gloveFile="path_for_glove_embedding", embed_size=300):
...
class POSvocab():
    def __init__(self,vocab_path):
        ...
        self.count = 0
        self.embedding = None
        with open(vocab_path+'chn_postag_set.p','rb') as f:
