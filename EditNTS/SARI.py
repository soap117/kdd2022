...
def main():
    ...
    fnamecomp   = "./turkcorpus/test.8turkers.tok.comp"
    fnamesimp   = "./turkcorpus/test.8turkers.tok.simp"
    fnameturk  = "./turkcorpus/test.8turkers.tok.turk."


    ssent = "About 95 species are currently accepted ." #input
    csent1 = "About 95 you now get in ." #output
    csent2 = "About 95 species are now agreed ." #output
    csent3 = "About 95 species are currently agreed ." #output
